  ...
  return (
    <nav className='flex items-center py-6 px-16 justify-between gap-40'>
       <div className='flex items-center gap-6'>
           <Link className='text-3xl text-black font-bold gap-8' to='/'>ShopEase</Link>
       </div>
...
//px-padding on x-axis -padding on left and right
//py-padding on y-axis -padding on top and bottom